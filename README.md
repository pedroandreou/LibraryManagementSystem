...
## :joystick: The logic behind the Transactions Table
...
### :window: How to set up a virtual environment on Windows:
```
...
### :ninja: How to set up a virtual environment on Linux:
...
### :yarn: How to play around with my db on Linux:
```
